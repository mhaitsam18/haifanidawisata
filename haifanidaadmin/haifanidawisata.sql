...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2021 at 08:10 AM
...
--
-- Table structure for table `aktivitas_pemesanan_tiket`
--
...
--
-- Dumping data for table `aktivitas_pemesanan_tiket`
--
...
--
-- Table structure for table `berkas_lunak`
--
...
--
-- Dumping data for table `berkas_lunak`
--
...
--
-- Table structure for table `bukti_pembayaran_paket`
--
...
--
-- Dumping data for table `bukti_pembayaran_paket`
--

INSERT INTO `bukti_pembayaran_paket` (`id`, `id_jamaah`, `id_rekening_tujuan`, `rekening_pengirim`, `bank_pengirim`, `nama_pengirim`, `waktu_transfer`, `nominal_transfer`, `bukti_pembayaran`, `catatan`, `status`) VALUES
(1, 1, 3, '1203129039213', 'BNI', 'Hariadi Arfah', '2021-04-18 16:03:00', 28000000.00, 'WhatsApp_Image_2021-04-06_at_11_18_59.jpeg', 'Okey', 'Pembayaran valid'),
(2, 3, 3, '1203129039213', 'BNI', 'Hariadi Arfah', '2021-06-25 10:46:00', 120000000.00, 'Group_21.png', 'oke', 'Pembayaran valid'),
(3, 4, 2, '1203129039213', 'BNI', 'Olga Paurenta', '2021-07-04 19:46:00', 300000000.00, '1200px-Telkom_University_Logo_svg.png', 'Terima Kasih', 'Belum dikonfirmasi'),
(4, 4, 3, '1234', 'BNI', 'Haitsam', '2021-07-05 08:27:00', 28000000.00, 'resize-pas_1.jpg', 'Terima kasih', 'Pembayaran valid'),
(5, 7, 1, '1203129039213', 'BNI', 'Alya Putri Maharani', '2021-07-06 17:14:00', 28000000.00, '1200px-Telkom_University_Logo_svg1.png', 'oke', 'Belum dikonfirmasi');
...
--
-- Dumping data for table `detail_pemesanan_tiket`
--
...
--
-- Triggers `detail_pemesanan_tiket`
--
DELIMITER $$
...
--
-- Table structure for table `haifa`
--
...
--
-- Table structure for table `haifa_menu`
--
...
--
-- Dumping data for table `haifa_menu`
--
...
--
-- Table structure for table `haifa_sub_menu`
--
...
--
-- Dumping data for table `haifa_sub_menu`
--
...
CREATE TABLE `jamaah` (
  ...
  `riwayat_umroh` enum('Pernah','Belum Pernah') NOT NULL,
  `golongan_darah` char(5) NOT NULL,
  `no_paspor` varchar(255) NOT NULL,
  `tanggal_cetak_paspor` date NOT NULL,
  `tempat_pembuatan_paspor` varchar(255) NOT NULL,
  `tanggal_habis_berlaku_paspor` date NOT NULL,
  `waktu_pemesanan` datetime NOT NULL,
...
(4, 'A38D2D7C33017EDE97E7EFB971F0DC98', '', 1, 3, 'Muhammad Haitsam', 'Haitsam Bin Fahruroji', '32151518029900002', 'WNI', 'Madinah', '1999-02-18', 'Laki-laki', 'Cilamaya', 'haitsam03@gmail.com', '082117503125', 6, 'Mahasiswa', 'Pernah', 'A', 'AF1367O', '2021-07-04', 'Jakarta', '2021-07-04', '2021-07-04 19:39:31', 28000000.00, 1, 28000000.00, 'Sudah Lunas'),
...
--
-- Table structure for table `kelengkapan_jamaah`
--
...
--
-- Dumping data for table `kelengkapan_jamaah`
--
...
--
-- Table structure for table `paket_unggulan`
--
...
--
-- Dumping data for table `paket_unggulan`
--
...
--
-- Table structure for table `tiket_shuttle`
--
...
--
-- Dumping data for table `tiket_shuttle`
--
...
--
-- Indexes for table `aktivitas_pemesanan_tiket`
--
...
--
-- Indexes for table `berkas_lunak`
--
...
--
-- Indexes for table `bukti_pembayaran_paket`
--
...
--
-- Indexes for table `haifa`
--
ALTER TABLE `haifa`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `haifa_menu`
--
ALTER TABLE `haifa_menu`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `haifa_sub_menu`
--
...
--
-- Indexes for table `kelengkapan_jamaah`
--
...
--
-- Indexes for table `paket_unggulan`
--
...
--
-- Indexes for table `tiket_shuttle`
--
...
--
-- AUTO_INCREMENT for table `aktivitas_pemesanan_tiket`
--
ALTER TABLE `aktivitas_pemesanan_tiket`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- AUTO_INCREMENT for table `berkas_lunak`
--
ALTER TABLE `berkas_lunak`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `bukti_pembayaran_paket`
--
ALTER TABLE `bukti_pembayaran_paket`
...
--
-- AUTO_INCREMENT for table `haifa`
--
ALTER TABLE `haifa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `haifa_menu`
--
ALTER TABLE `haifa_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `haifa_sub_menu`
--
ALTER TABLE `haifa_sub_menu`
...
--
-- AUTO_INCREMENT for table `kelengkapan_jamaah`
--
ALTER TABLE `kelengkapan_jamaah`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT for table `paket_unggulan`
--
ALTER TABLE `paket_unggulan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `tiket_shuttle`
--
ALTER TABLE `tiket_shuttle`
