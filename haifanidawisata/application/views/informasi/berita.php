		...
		<div class="row push-down-100">
			<div class="col-md-3">
				<div class="travel_sidebar_wrapper">
					...
					<form action="<?= base_url('Informasi/berita/') ?>" method="post">
					...
					<div class="post_wrapper">
						...
						<?php foreach ($berita as $item): ?>
							<div class="travel_post">
								...
								<img src="<?= base_url2('assets/img/berita/').$item['thumbnail'] ?>" alt="berita" />
								<?php 
								...
								if ($jml_karakter>280) {
								 ...
								 ?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/berita/'.$item['id']) ?>" class="btn-travel btn-green">Read More</a>
							</div>
						<?php endforeach ?>
						<!-- <div class="travel_post">
							<h3>Holiday Tours</h3>
