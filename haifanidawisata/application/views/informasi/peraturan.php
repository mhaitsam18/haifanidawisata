		...
		<div class="row push-down-100">
			<div class="col-md-3">
				<div class="travel_sidebar_wrapper">
					...
					<form action="<?= base_url('Informasi/peraturan/') ?>" method="post">
						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingThree">
									<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Recent_peraturan" aria-expanded="false"> Recent peraturan </a> </h4>
								</div>
								<div id="Recent_peraturan" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
									<div class="panel-body">
										<aside class="widget widget_recent_entries">
											<ul>
												<li>
													<img src="<?= base_url('assets/') ?>images/peraturan/recent_peraturan_footer1.jpg" alt="Recent peraturan" />
													<div>
														<p>Nunc cursus libero purus ac congue arcu cursus..</p>
														<a href="#">Read More</a>
													</div>
												</li>
												<li> <img src="<?= base_url('assets/') ?>images/peraturan/recent_peraturan_footer2.jpg" alt="Recent peraturan" />
													<div>
														<p>Nunc cursus libero purus ac congue arcu cursus..</p>
														<a href="#">Read More</a>
													</div>
					...
					<?php if ($num_peraturan): ?>
						...
						<?php foreach ($peraturan as $item): ?>
							<div class="travel_post">
								...
								<img src="<?= base_url2('assets/img/peraturan/').$item['thumbnail'] ?>" alt="peraturan" />
								<?php 
								...
								if ($jml_karakter>280) {
								 ...
								 ?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/peraturan/'.$item['id']) ?>" class="btn-travel btn-green">Read More</a>
							</div>
						<?php endforeach ?>
