						...
						<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingThree">
									<h4 class="panel-title"> <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#Recent_pengumuman" aria-expanded="false"> Recent pengumuman </a> </h4>
								</div>
								...
								<div id="About_us" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
									<div class="panel-body">
										<aside class="widget widget_text">
											<p>Welcome to our pengumuman!<br>
						...
						<?php foreach ($pengumuman as $item): ?>
							<div class="travel_post">
								...
								if ($jml_karakter>280) {
								 ...
								 ?>
								<?= $isi ?>
								<a href="<?= base_url('Informasi/detail/pengumuman/'.$item['id']) ?>" class="btn-travel btn-green">Read More</a>
							</div>
						<?php endforeach ?>
