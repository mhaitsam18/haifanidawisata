			...
			<div class="col-md-9">
				<div class="blog_single_page_wrapper">
					<div class="travel_post_switcher">
						...
						?>
						<a href="<?= base_url("Informasi/detail/$konten/$prev") ?>" class="previous_post"><i class="fa fa-caret-left"></i> Previous Post</a>
						<a href="<?= base_url("Informasi/detail/$konten/$next") ?>" class="next_post">Next Post <i class="fa fa-caret-right"></i></a>
					</div>
					<?php if ($num_konten >= 1): ?>
						<div class="travel_post">
											...
											<div class="article">
												...
												<div class="comment-body">
													<div class="comment-meta">
														...
														<div class="comment-date"><a href="javascript:;">6 Hours ago</a></div>
							...
							<div id="respond" class="comment-respond">
								<h3 id="reply-title" class="comment-reply-title">Leave a Comments<small><a rel="nofollow" id="cancel-comment-reply-link" href="http://kamleshyadav.in/wp/adelia/blog-image-post/#respond" style="display: none;">Cancel reply</a></small></h3>
								<form id="commentform" class="comment-form">
									...
									<p class="form-submit">
										<input name="submit" type="submit" id="submit" class="btn-travel btn-green" value="send">
									</p>
								</form>
							</div>
							<!--Comment reply end-->
