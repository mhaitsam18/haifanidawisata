				...
				<div class="col-lg-5 col-md-5 col-sm-8 col-xs-8">
					<div class="left_side_slider">
						<ul class="about_slider">
							<li><img src="<?= base_url('assets/') ?>images/about/shutterstock.jpg" alt=""></li>
							<li><img src="<?= base_url('assets/') ?>images/about/shutterstock.jpg" alt=""></li>
							<li><img src="<?= base_url('assets/') ?>images/about/shutterstock.jpg" alt=""></li>
						</ul>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="tr_team_wrapper full_width">
						<div class="thumb_wrap">
							<img src="<?= base_url('assets/') ?>images/about/team-one.jpg"  class="img-responsive" alt="">
						</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="tr_team_wrapper full_width">
						<div class="thumb_wrap">
							<img src="<?= base_url('assets/') ?>images/about/team-two.jpg" class="img-responsive" alt="">
						</div>
						<div class="tr_team_desc">
							<h4>steven smith</h4>
							<div class="title_tag">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="tr_team_wrapper full_width">
						<div class="thumb_wrap">
							<img src="<?= base_url('assets/') ?>images/about/team-three.jpg" class="img-responsive" alt="">
						</div>
						<div class="tr_team_desc">
							<h4>ana levely</h4>
							<div class="title_tag">
				...
				<div class="col-lg-3 col-md-3 col-sm-6">
					<div class="tr_team_wrapper full_width">
						<div class="thumb_wrap">
							<img src="<?= base_url('assets/') ?>images/about/team-four.jpg" class="img-responsive" alt="">
						</div>
						<div class="tr_team_desc">
