				...
				<div class="row">
					<div class="col-md-4">
						<aside class="widget widget_text">
							...
							<a href="<?= base_url() ?>"><img src="<?= base_url('assets/') ?>img/logo/Haifa.png" width="150" alt="footer logo" /></a>
							<p>
						...
						<aside class="widget widget_tag_cloud">
							...
							<div class="tagcloud"> <a href="https://simpu.kemenag.go.id/home/detail/617" target="_blank">SiskoPatuh</a> <a href="https://mauzafiq.com/haifa-nida-wisata-karawang/" target="_blank">MUZAFIQ</a> <a href="https://himpuh.or.id/daftar-anggota/detail/307/pt-haifa-nida-wisata-karawang" target="_blank">HIMPUH</a> <a href="https://haifa-nida-wisata.business.site/" target="_blank">Blog</a> <a href="#">Travel</a> <a href="<?= base_url2() ?>">Admin</a> <a href="<?= base_url3() ?>">Agent</a> <a href="#">Booking</a> <a href="#">Hotels</a> <a href="#">Cars</a> <a href="#">Flights</a> <a href="#">Tours</a> <a href="#">Umroh</a> <a href="#">Haji</a> </div>
						</aside>
					</div>
					<div class="col-md-4">
						<aside class="widget widget_recent_entries">
							...
							<ul>
								<li>
									...
									$blog_footer = $this->db->get('blog', 1)->row_array(); ?>
									<img src="<?= base_url2('assets/img/blog/' . $blog_footer['thumbnail']) ?>" alt="Recent blog" />
									<div>
										<p>
											<?php
											$jml_karakter = strlen($blog_footer['isi']);
											if ($jml_karakter > 50) {
												$isi = strrev($blog_footer['isi']);
												$x = $jml_karakter - 50;
												$isi = substr($isi, $x);
												$isi = strrev($isi) . '</p>';
											} else {
								...
								<li>
									<?php
									$this->db->order_by('terakhir_diubah', 'DESC');
									$berita_footer = $this->db->get('berita', 1)->row_array(); ?>
									<img src="<?= base_url2('assets/img/berita/' . $berita_footer['thumbnail']) ?>" alt="Recent blog" />
									<div>
										<p>
											<?php
											$jml_karakter = strlen($berita_footer['isi']);
											if ($jml_karakter > 50) {
												$isi = strrev($berita_footer['isi']);
												$x = $jml_karakter - 50;
												$isi = substr($isi, $x);
												$isi = strrev($isi) . '</p>';
											} else {
												$isi = $berita_footer['isi'];
											}
											echo $isi;
											?>
										</p>
					...
					<div class="col-md-4">
						<aside class="widget widget_search_availability">
							<div class="wsa_tab">
								<ul>
									<li><a href="#widget_global_search"> <svg version="1.1" id="widget_global_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="48.999px" height="48.999px" viewBox="0 0 48.999 48.999" style="enable-background:new 0 0 48.999 48.999;" xml:space="preserve">
												<g>
									...
									<li><a href="#widget_hotal_search"><svg version="1.1" id="widget_hotal_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
												<g>
													<g id="hotel">
									...
									<li><a href="#widget_flight_search"> <svg version="1.1" id="widget_flight_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 375.04 375.04" style="enable-background:new 0 0 375.04 375.04;" xml:space="preserve">
												<g>
													<g id="Layer_5_77_">
									...
									<li><a href="#widget_local_search"> <svg version="1.1" id="widget_local_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="444.103px" height="444.103px" viewBox="0 0 444.103 444.103" style="enable-background:new 0 0 444.103 444.103;" xml:space="preserve">
												<g>
		...
		<script>
			$(document).ready(function() {
				...
				var $checkboxes = $('.list_destination input');
				...
				var $checkboxes2 = $('.list_kategori_wisata input');
				$checkboxes2.change(function() {
					var filters = [];
					console.log(filters);
					// get checked checkboxes2 values
					$checkboxes2.each(function(i, elem) {
						// if checkbox, use value if checked
						if (elem.checked) {
							filters.push(elem.value);
						}
				...
				var $checkboxes3 = $('.list_kategori input');
				$checkboxes3.change(function() {
					var filters = [];
					console.log(filters);
					// get checked checkboxes2 values
					$checkboxes3.each(function(i, elem) {
						// if checkbox, use value if checked
						if (elem.checked) {
							filters.push(elem.value);
						}
		...
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/datetimepicker/jquery.datetimepicker.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/parallax/jquery.parallax-1.1.3.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/owl/owl.carousel.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/isotope/jquery.isotope.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/bxslider/jquery-bxslider.js"></script>
		<!-- pie chart js -->
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/pie-circle/circles.js"></script>
		<!-- pie chart js -->
		<!--counter js-->
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/counter/jquery.countTo.js"></script>
		<!--counter js-->
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/counter/jquery.countdown.js"></script><!-- REVOLUTION JS FILES -->
		<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyAuVARCEVxBRvlO9WjjTTTn6B-azVeVb1M&callback=initMap"></script>
		<?php if ($this->uri->segment(2) == 'hubungiKami' || $this->uri->segment(1) == 'Shuttle') : ?>
			<script>
				function initMap() {}
				$(document).ready(function() {
					var myCenter = new google.maps.LatLng(-6.2996776663695355, 107.29938552988462);
					...
					function initialize() {
						...
						var icon = {
							// url: '<?= base_url('assets/') ?>images/map_marke_icon.png'
							url: '<?= base_url('assets/') ?>images/icons/map-marker.png'
						};
						...
						// 	content:"Haifa Nida wisata"
						// });
						// google.maps.event.addListener(marker, 'click', function() {
						// 	infowindow.open(map,marker);
						// });

						<?php $footer_alamat = $this->db->get('kantor')->result_array(); ?>
						<?php foreach ($footer_alamat as $key) : ?>
							marker<?= $key['id'] ?> = new google.maps.Marker({
								position: new google.maps.LatLng(<?= $key['latitude'] ?>, <?= $key['longitude'] ?>),
								map: map,
								title: '<?= $key['nama_kantor'] ?>',
								icon: icon
							});
							marker<?= $key['id'] ?>.setMap(map);
							google.maps.event.addListener(marker<?= $key['id'] ?>, 'click', function() {
								infowindow.open(map, marker<?= $key['id'] ?>);
								infowindow.setContent("<?= $key['nama_kantor'] ?>");
							});
		...
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/jquery.themepunch.tools.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/jquery.themepunch.revolution.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/revolution.extension.layeranimation.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/revolution.extension.navigation.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/revolution.extension.slideanims.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/revolution.extension.actions.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/revolution/js/revolution.extension.parallax.min.js"></script>
		<script src="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js"></script>

		<!-- REVOLUTION JS FiLES -->
		<!-- video_popup -->
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/video-popup/jquery.magnific-popup.js"></script><!-- video_popup -->
		<!-- slick slider -->
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/slick/jquery-migrate-1.2.1.min.js"></script>
		<script type="text/javascript" src="<?= base_url('assets/') ?>js/plugin/slick/slick.min.js"></script>
		<!-- slick slider -->
		<!-- video player js -->
		<script src="<?= base_url('assets/') ?>js/plugin/video_player/mediaelement-and-player.min.js"></script>
		<!-- video player js -->
		...
		<!-- pricefilter -->
		<script src="<?= base_url('assets/') ?>js/plugin/jquery-ui/jquery-ui.js"></script>
		<script src="<?= base_url('assets/') ?>js/haifa-script.js"></script>
		<!-- pricefilter-->
		...
		<script type="text/javascript">
			...
			const shuttle_gagal = $('.shuttle_gagal').data('shuttle_gagal');
		...
		<?php if ($this->uri->segment(2) == "strukturOrganisasi") { ?>
			...
			<script>
				function init() {
					...
					function findHeadShot(key) {
						if (key) {
							console.log(key);
							return `<?= base_url2('assets/img/struktur-organisasi/'); ?>${key}`;
						} else {
							console.log(key);
							return `<?= base_url2('assets/img/struktur-organisasi/'); ?>default.png`;
						}
					}
		...
		<script>
			$(document).ready(function() {
				setInterval(function() {
					$('#show').load('<?= base_url('Home/notifikasi') ?>')
				}, 30000);
			});
			...
			function notifikasi() {
				$.ajax({
					type: "POST",
					url: '<?= base_url('Home/readAllNotification') ?>',
		...
		<!-- Mirrored from kamleshyadav.in/html/travelite/travelite-default/Home_02.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jul 2020 08:41:14 GMT -->
