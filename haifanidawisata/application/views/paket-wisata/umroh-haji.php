					...
					<div class="tour_packages_right_section left_space_40">
						...
						<div class="full_width sorting_panel">
							...
							<div class="pull-right sort_list_grid">
								<a href="<?= base_url('PaketWisata/umroh/grid') ?>"><i class="fa fa-th-large <?php if($list == 'grid'): echo('active_sort'); endif; ?>"></i></a>
								<a href="<?= base_url('PaketWisata/umroh/list') ?>"><i class="fa fa-th-list <?php if($list == 'list'): echo('active_sort'); endif; ?>"></i></a>
							</div>
							<!-- sorting list end-->
						</div>
						<!--  sorting panel End -->
